...
<!-- closing head -->
    ...
    <body> <!--INLINE STYLE EXAMPLE style="background-color:black; color:white;"-->
        ...
        <div id="content">
            ...
            <ul>
                <li> <span class="hobby">Video games</span>: I own four consoles and love all games but my favorite is Legend of Zelda </li>
                <li><span class="hobby">Soccer</span>: I am part of a team and we play every Saturday. I am the goalie.</li>
                <li><span class="hobby">Music</span>: I love all kinds of music by my favorite is R&B and Pop</li>
                <li><span class="hobby">Programming</span>: I spend at least two hours a day using and learning programming languages</li>
            </ul>
