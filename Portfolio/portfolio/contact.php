...
<!-- closing head -->
    ...
    <body> <!--INLINE STYLE EXAMPLE style="background-color:black; color:white;"-->
        ...
        <div id="content">
            <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSdkvMaCXniB6Ln2e6T9GUoXrIjan7k8w7ZNjewzxjiDflvLww/viewform?embedded=true" width="760" height="500" frameborder="0" marginheight="0" marginwidth="0" style="float:middle">Loading...</iframe>
        </div>
